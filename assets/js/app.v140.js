(() => {
  ...
  function renderFixtures() {
    ...
    container.innerHTML = fixtures.slice(0, 16).map((fixture) => {
      const analysis = analysisForFixture(fixture);
      const confidence = fixture.livePrediction ? percent(analysis.confidence, 1) : "Pending";
      ...
      return `<button class="fixture-item ${fixture.id === selectedId ? "active" : ""}" data-id="${escapeHtml(fixture.id)}">
        ...
        <div class="fixture-bottom">
          <strong>${escapeHtml(analysis.primary.label)}</strong>
