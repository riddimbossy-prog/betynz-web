const CACHE='betynz-v5.8.0';
const CORE=[
  '/',
  '/index.html',
  '/styles.css?v=5.8',
  '/app.js?v=5.8',
  '/community-features.js?v=5.8',
  '/backend-config.js?v=5.8',
  '/backend-client.js?v=5.8',
  '/monetization-config.js?v=5.8',
  '/rebel-engine-core.js?v=5.8',
  '/olympian-engine-core.js?v=5.8',
